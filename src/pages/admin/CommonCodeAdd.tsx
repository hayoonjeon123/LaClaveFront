...
export function CommonCodeAdd() {
    ...
    return (
        <div className="w-full max-w-[1200px] mx-auto space-y-16 font-['Inter',sans-serif]">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-[#F5F5F5] p-10 rounded-lg space-y-6">
                    ...
                    <div className="grid grid-cols-[160px_1fr] gap-6 items-center">
                        ...
                        <div className="flex gap-4 items-center">
                            <input
                                ...
                                className="w-full max-w-5xl px-6 py-4 text-lg border border-gray-300 rounded-[5px] focus:outline-none focus:border-[#5C4033]"
                            />
                            <button className="px-10 py-4 bg-[#5C4033] text-white text-lg rounded-[5px] font-bold hover:bg-[#4a332a] transition-colors whitespace-nowrap">
                                그룹 저장
                            </button>
                        </div>
                    </div>
            ...
            <div className="space-y-6">
                ...
                <div className="w-full bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
                    <div className="flex bg-[#5C4033] text-white py-6 text-center font-bold text-lg">
                            ...
                            <div key={row.id} className="flex items-center text-center py-5 px-6 gap-6">
                                ...
                                <div className="w-[120px] flex justify-center">
                                    <button
                                        ...
                                        className="px-6 py-2 bg-[#5C4033] text-white text-base rounded-[5px] hover:bg-[#4a332a]"
                                    >
                                        삭제
                                    </button>
                                </div>
                ...
                <div className="flex justify-end gap-4 mt-6">
                    <button
                        ...
                        className="px-8 py-3 bg-[#5C4033] text-white text-lg rounded-[5px] font-bold hover:bg-[#4a332a] transition-colors"
                    >
                        행 추가
                    </button>
                    <button className="px-8 py-3 bg-[#5C4033] text-white text-lg rounded-[5px] font-bold hover:bg-[#4a332a] transition-colors">
                        선택된 코드 저장
                    </button>
                </div>
            </div>
