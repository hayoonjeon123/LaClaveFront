...
const MemberExchange = () => {
  ...
  const tabs = [
    { label: "전체", value: "ALL" },
    { label: "교환신청", value: "APPLY" },
    { label: "교환처리중", value: "PROCESSING" },
    { label: "교환완료", value: "COMPLETED" },
    { label: "교환준비/보류", value: "PENDING" },
    { label: "접수거부/철회", value: "REJECTED" },
  ];
  ...
  return (
    <div className="flex-1 bg-[#F5F5F5] p-[20px] min-h-screen">
      {/* 페이지 타이틀 */}
      <h2 className="text-[24px] font-bold mb-[20px]">교환 관리</h2>
        ...
        <table className="w-full text-center border-collapse text-[13px]">
          <thead>
            <tr className="bg-[#5C4033] text-white h-[45px]">
              ...
              <th className="font-normal px-2">교환처리</th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((row, i) => (
