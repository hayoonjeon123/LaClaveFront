...
const MemberCancel = () => {
  ...
  const tabs = [
    { label: "전체", value: "ALL" },
    { label: "취소신청", value: "APPLY" },
    { label: "취소처리중", value: "PROCESSING" },
    { label: "취소완료", value: "COMPLETED" },
  ...
  return (
    <div className="flex-1 bg-[#F5F5F5] p-[20px] min-h-screen">
      {/* 페이지 타이틀 */}
      <h2 className="text-[24px] font-bold mb-[20px]">취소 관리</h2>
        ...
        <table className="w-full text-center border-collapse text-[13px]">
          <thead>
            <tr className="bg-[#5C4033] text-white h-[45px]">
              ...
              <th className="font-normal px-2">취소처리</th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((row, i) => (
