      ...
      content: (
        <div className="flex flex-col items-center gap-4">
          ...
          {productData.productDetailDesc && (
            <div
              className="w-full py-10 px-4 text-gray-800 leading-relaxed whitespace-pre-wrap border-t border-gray-100 mt-8"
              dangerouslySetInnerHTML={{
                __html: productData.productDetailDesc,
              }}
            />
          )}
        </div>
          ...
          <div className="flex flex-col max-w-[500px] w-full mx-auto">
            <div className="mb-6">
              <h3 className="text-[24px] font-['Luxurious_Script'] text-[#5C4033] mb-2 flex items-center gap-2">
                La Clavé{" "}
                <span className="text-black text-base font-bold uppercase tracking-wider">
                  Laclave
                </span>
              </h3>
