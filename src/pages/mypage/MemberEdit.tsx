...
export default function MemberEdit() {
    ...
    const [formData, setFormData] = useState({
        ...
        address: "부산광역시 부산진구 중앙대로692번길 34로"
    });
        ...
        <div className="pb-4 bg-white">
            ...
            <div className="max-w-[1000px] mx-auto px-6 pt-6 flex items-center relative mb-6">
                ...
                <div className="flex-1 text-center">
                    <h2 className="text-[32px] font-bold text-[#5C4033] tracking-tighter">회원정보 수정</h2>
                </div>
            </div>
            ...
            <div className="max-w-[800px] mx-auto bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
                ...
                <div className="space-y-4 px-4">
                    ...
                    <div className="border-b border-gray-300 pb-2">
                        <label className="block text-[16px] font-bold text-[#5C4033] mb-1">이름</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
                    ...
                    {/* 닉네임 */}
                    <div className="border-b border-gray-300 pb-2">
                        <label className="block text-[16px] font-bold text-[#5C4033] mb-1">닉네임</label>
                        <input
                            type="text"
                            name="nickname"
                    ...
                    >
                        <div className="flex-1">
                            <label className="block text-[16px] font-bold text-[#5C4033] mb-1">비밀번호</label>
                            <input
                                type="password"
                                name="password"
                        ...
                        <ChevronRight size={28} className="text-gray-900 mb-1 group-hover:translate-x-1 transition-transform" />
                    </div>

                    {/* 생년월일 */}
                    <div className="border-b border-gray-300 pb-2">
                        <label className="block text-[16px] font-bold text-[#5C4033] mb-1">생년월일</label>
                        <input
                            type="text"
                            name="birthdate"
                    ...
                    {/* 주소 */}
                    <div className="border-b border-gray-300 pb-2">
                        <label className="block text-[16px] font-bold text-[#5C4033] mb-1">주소</label>
                        <input
                            type="text"
                            name="address"
